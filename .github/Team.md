...
## 1. Onze Ambitie 
 Wij willen als team een volledig werkende crud applicatie opleveren en meer kunnen leren over PHP databases. Wij gaan altijd voor een mooie cijfer.
 
## 2. Rol- en Taakverdeling 
*Iedereen schrijft code en ontwerpt, maar de Leads hakken de knopen door
bij twijfel.* 
* **Scrum Master:** [Atakan Erdem] *(Verantwoordelijk voor Stand-ups, GitHub
Projects board en communicatie)* 
* **Lead Design:** [Maurits de Vries] *(Bewaakt visuele stijl en UI/UX keuzes)* 
* **Lead Git/Dev:** [Thomas Rijsdijk] *(Bewaakt code quality en let streng op PR's)* 
